...
public final class ForumTests {
    ...
    @Test
    public void canGetQuestionsFromForum(){
    ...
    @Test
    public void cannotPostAnswerToOwnQuestion() {
        forum.postQuestion(alice, "Question text");
        Question question = forum.getQuestions().get(0);

        try {
            forum.postAnswer(alice, question, "Answer text");
        } catch (IllegalOperationException e) {
            return;
        }

        fail("Should have thrown a IllegalOperationException.");
    }
